...
我平常使用的笔记软件是[SiYuan](https://github.com/siyuan-note/siyuan)，并开发了几个插件，希望对你有帮助
::github{repo="Halory-Ito/siyuan-plugin-iconify-set"}
::github{repo="Halory-Ito/siyuan-plugin-wallpaper-engine-bg"}
