...
export const fontsList: FontDefinition[] = [
  ...
  // 3. 在 fontConfig.selected 或区域字段中引用 cssVariable
  {
    ...
    cssVariable: "--font-source-han",
    provider: "local",
    options: {
      variants: [
        {
          src: ["./public/assets/fonts/SourceHanSerifCN.otf"],
        },
      ],
    },
    fallbacks: ["Source Serif Pro", "sans-serif"],
  },
];
