...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
  ...
  src: {
    ...
    desktop: [
      "assets/images/DesktopWallpaper/01.png",
      "assets/images/DesktopWallpaper/02.png",
      "assets/images/DesktopWallpaper/03.png",
      "assets/images/DesktopWallpaper/04.png",
      "assets/images/DesktopWallpaper/05.png",
      "assets/images/DesktopWallpaper/06.png",
    ],
    // 移动背景图片（支持单张或多张随机）
  ...
  common: {
    ...
    homeText: {
      ...
      subtitle: [
        "此时的我想必一定心生雀跃吧",
        "我喜欢的不是冬天哦，我喜欢的是雪",
        "看着女孩子怀着不安的心情走夜路，也不去送的男生是最差劲的",
        "即便我不能发光，只要她能闪耀，我便感到高兴……",
        "因为我说了会努力，所以请你帮我加油哦",
        "玩弄男孩纯情的家伙，给我下地狱反省吧",
      ],
      // 主页横幅副标题字体大小
